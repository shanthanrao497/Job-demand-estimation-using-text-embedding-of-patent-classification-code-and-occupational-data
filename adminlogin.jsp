...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1 class="style3">Job Demand Estimation Using Text Embeddings of Patent Classification Codes and Occupational Data</h1>
      </div>
      <div class="menu_nav">
        <ul>
          <li><a href="index.html"><span>Home</span></a></li>
          <li><a href="userlogin.jsp"><span>User</span></a></li>
		  <li class="active"><a href="adminlogin.jsp"><span>Server</span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Welcome to Server Login </span></h2>
          <div class="clr"></div>
